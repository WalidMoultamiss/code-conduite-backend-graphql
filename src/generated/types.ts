...
import { LicenseType } from '../ts/enums';
...
export type LicenseTypeResolvers = EnumResolverSignature<{ A?: any, B?: any }, ResolversTypes['LicenseType']>;

export type MutationResolvers<ContextType = Context, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
  submitData?: Resolver<Maybe<ResolversTypes['User']>, ParentType, ContextType, Partial<MutationSubmitDataArgs>>;
};
...
export type Resolvers<ContextType = Context> = {
  LicenseType?: LicenseTypeResolvers;
